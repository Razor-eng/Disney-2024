...
function Slider() {
    ...
    scrollbar-none scroll-smooth' ref={elementRef}>
                {movieList.map((item, id) => (
                    <img key={id} src={IMAGE_BASE_URL + item.backdrop_path}
                        className='min-w-full  md:h-[420px] object-fit
